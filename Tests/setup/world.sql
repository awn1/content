-- Script downloaded from: https://dev.mysql.com/doc/index-other.html
-- Modifications:
-- * Commented out: drop/create schema. So script can will not depend on database name
--
-- Setup:
-- CREATE DATABASE <dbname>;
-- GRANT ALL PRIVILEGES ON *.<dbname> TO '<username>'@'%' IDENTIFIED BY '<password>';
--
-- Usage (-v is optional but recommended to see progress):
-- mysql --ssl-mode=REQUIRED --host=<host> --user=<username> '-p<password>' -v <dbname> < world.sql
