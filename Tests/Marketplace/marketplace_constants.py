...
BASE_PACK_DEPENDENCY_DICT = {
    "Base": {"mandatory": True, "author": "Cortex XSOAR", "minVersion": "1.0.0", "name": "Base", "certification": ""}
}
...
class PackFolders(enum.Enum):
    ...
    def pack_displayed_items(cls):
        return {
            PackFolders.SCRIPTS.value,
            PackFolders.DASHBOARDS.value,
            PackFolders.INCIDENT_FIELDS.value,
            PackFolders.INCIDENT_TYPES.value,
            PackFolders.INTEGRATIONS.value,
            PackFolders.PLAYBOOKS.value,
            PackFolders.INDICATOR_FIELDS.value,
            PackFolders.REPORTS.value,
            PackFolders.INDICATOR_TYPES.value,
            PackFolders.LAYOUTS.value,
            PackFolders.CLASSIFIERS.value,
            PackFolders.WIDGETS.value,
            PackFolders.GENERIC_DEFINITIONS.value,
            PackFolders.GENERIC_FIELDS.value,
            PackFolders.GENERIC_MODULES.value,
            PackFolders.GENERIC_TYPES.value,
            PackFolders.LISTS.value,
            PackFolders.JOBS.value,
            PackFolders.PARSING_RULES.value,
            PackFolders.MODELING_RULES.value,
            ...
            PackFolders.LAYOUT_RULES.value,
...
class PackStatus(enum.Enum):
    ...
    FAILED_DECRYPT_PACK = "Failed to decrypt pack: a premium pack," " which should be encrypted, seems not to be encrypted."
    ...
    FAILED_CREATING_DEPENDENCIES_ZIP_SIGNING = (
        "Failed creating dependencies zip since a depending pack or this " "pack failed signing or zipping"
    )
