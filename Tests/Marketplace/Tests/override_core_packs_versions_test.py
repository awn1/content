...
def test_should_override_locked_corepacks_file(mocker, mocked_content_repo):
    ...
    corepacks_override = {
        "server_version": "8.3.0",
        "xsoar": {"updated_corepacks_content": {"corePacks": [], "upgradeCorePacks": [], "buildNumber": "123"}},
    }
    ...
    corepacks_override = {
        "server_version": "8.2.0",
        "marketplacev2": {"updated_corepacks_content": {"corePacks": [], "upgradeCorePacks": [], "buildNumber": "123"}},
    }
    mocker.patch.object(GCPConfig, "corepacks_override_contents", corepacks_override)
    assert not should_override_locked_corepacks_file(marketplace, last_upload_commit)
...
def test_override_locked_corepacks_file(mocker):
    ...
    corepacks_override = {
        "server_version": "8.2.0",
        "xsoar": {
            "updated_corepacks_content": {"corePacks": ["pack1", "pack2"], "upgradeCorePacks": ["pack3"], "buildNumber": "123"}
        },
    }
    mocker.patch.object(GCPConfig, "corepacks_override_contents", corepacks_override)
