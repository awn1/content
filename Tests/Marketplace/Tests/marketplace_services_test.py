...
CHANGELOG_DATA_INITIAL_VERSION = {
    "1.0.0": {"releaseNotes": "Sample description", "displayName": "1.0.0 - 62492", "released": "2020-12-21T12:10:55Z"}
}
CHANGELOG_DATA_MULTIPLE_VERSIONS = {
    "1.0.0": {"releaseNotes": "Sample description", "displayName": "1.0.0 - 62492", "released": "2020-12-21T12:10:55Z"},
    "1.1.0": {"releaseNotes": "Sample description2", "displayName": "1.1.0 - 64321", "released": "2021-01-20T12:10:55Z"},
}
TEST_METADATA = {
...
AGGREGATED_CHANGELOG = {
    "1.0.1": {"releaseNotes": "dummy release notes", "displayName": "1.0.0 - 264879", "released": "2020-05-05T13:39:33Z"},
    "1.0.3": {
...
CHANGELOG_ONE_LAST_YEAR_SAME_MINOR = {
    "1.0.0": {"releaseNotes": "dummy release notes", "displayName": "1.0.0 - 123456", "released": "2020-05-05T13:39:33Z"},
    "1.0.1": {"releaseNotes": "dummy release notes", "displayName": "1.0.1 - 123456", "released": "2020-05-05T13:39:33Z"},
    "1.0.2": {"releaseNotes": "dummy release notes", "displayName": "1.0.2 - 123456", "released": "2021-01-27T23:01:58Z"},
    "1.0.3": {"releaseNotes": "dummy release notes", "displayName": "1.0.3 - 123456", "released": "2021-01-27T23:01:58Z"},
    "1.0.4": {"releaseNotes": "dummy release notes", "displayName": "1.0.4 - 123456", "released": "2021-01-27T23:01:58Z"},
    "1.0.5": {"releaseNotes": "dummy release notes", "displayName": "1.0.5 - 123456", "released": "2021-01-27T23:01:58Z"},
    "1.0.6": {"releaseNotes": "dummy release notes", "displayName": "1.0.6 - 123456", "released": "2023-01-01T23:01:58Z"},
}

CHANGELOG_TEN_LAST_YEAR_DIFFERENT_MINOR = {
    "1.0.0": {"releaseNotes": "dummy release notes", "displayName": "1.0.0 - 123456", "released": "2022-05-05T13:39:33Z"},
    "1.1.0": {"releaseNotes": "dummy release notes", "displayName": "1.1.0 - 123456", "released": "2022-09-27T23:01:58Z"},
    "1.2.0": {"releaseNotes": "dummy release notes", "displayName": "1.0.3 - 123456", "released": "2022-10-27T23:01:58Z"},
    "1.3.0": {"releaseNotes": "dummy release notes", "displayName": "1.3.0 - 123456", "released": "2022-11-27T23:01:58Z"},
    "1.3.1": {"releaseNotes": "dummy release notes", "displayName": "1.3.1 - 123456", "released": "2022-12-01T23:01:58Z"},
    "1.3.2": {"releaseNotes": "dummy release notes", "displayName": "1.3.2 - 123456", "released": "2023-01-01T23:01:58Z"},
}

CHANGELOG_MINOR_CHANGED_LAST_RELEASE_OLD_CHANGES = {
    "1.0.0": {"releaseNotes": "dummy release notes", "displayName": "1.0.0 - 123456", "released": "2020-05-05T13:39:33Z"},
    "1.0.1": {"releaseNotes": "dummy release notes", "displayName": "1.0.0 - 123456", "released": "2020-05-05T13:39:33Z"},
    "1.0.2": {"releaseNotes": "dummy release notes", "displayName": "1.0.2 - 123456", "released": "2021-01-27T23:01:58Z"},
    "1.0.3": {"releaseNotes": "dummy release notes", "displayName": "1.0.3 - 123456", "released": "2021-01-27T23:01:58Z"},
    "1.0.4": {"releaseNotes": "dummy release notes", "displayName": "1.0.4 - 123456", "released": "2021-01-27T23:01:58Z"},
    "1.1.0": {"releaseNotes": "dummy release notes", "displayName": "1.1.0 - 123456", "released": "2021-11-01T23:01:58Z"},
}

CHANGELOG_MINOR_CHANGED_LONG_TIME_AGO = {
    "1.0.0": {"releaseNotes": "dummy release notes", "displayName": "1.0.0 - 123456", "released": "2020-05-05T13:39:33Z"},
    "1.1.0": {"releaseNotes": "dummy release notes", "displayName": "1.1.0 - 123456", "released": "2021-01-27T23:01:58Z"},
    "1.1.1": {"releaseNotes": "dummy release notes", "displayName": "1.1.1 - 123456", "released": "2021-01-27T23:01:58Z"},
    "1.1.2": {"releaseNotes": "dummy release notes", "displayName": "1.1.2 - 123456", "released": "2021-01-27T23:01:58Z"},
    "1.1.3": {"releaseNotes": "dummy release notes", "displayName": "1.1.3 - 123456", "released": "2021-01-27T23:01:58Z"},
    "1.1.4": {"releaseNotes": "dummy release notes", "displayName": "1.1.4 - 123456", "released": "2021-01-27T23:01:58Z"},
    "1.1.5": {"releaseNotes": "dummy release notes", "displayName": "1.1.5 - 123456", "released": "2021-01-27T23:01:58Z"},
    "1.1.6": {"releaseNotes": "dummy release notes", "displayName": "1.1.6 - 123456", "released": "2021-11-01T23:01:58Z"},
    "1.1.7": {"releaseNotes": "dummy release notes", "displayName": "1.1.7 - 123456", "released": "2021-11-01T23:01:58Z"},
}

CHANGELOG_MINOR_MAJOR_CHANGES = {
    "1.0.0": {"releaseNotes": "dummy release notes", "displayName": "1.0.0 - 123456", "released": "2020-05-05T13:39:33Z"},
    "1.1.0": {"releaseNotes": "dummy release notes", "displayName": "1.1.0 - 123456", "released": "2021-01-27T23:01:58Z"},
    "2.0.0": {"releaseNotes": "dummy release notes", "displayName": "2.0.0 - 123456", "released": "2021-01-27T23:01:58Z"},
    "2.1.0": {"releaseNotes": "dummy release notes", "displayName": "2.1.0 - 123456", "released": "2021-01-27T23:01:58Z"},
    "3.0.0": {"releaseNotes": "dummy release notes", "displayName": "3.0.0 - 123456", "released": "2021-01-27T23:01:58Z"},
    "3.1.0": {"releaseNotes": "dummy release notes", "displayName": "3.1.0 - 123456", "released": "2021-01-27T23:01:58Z"},
    "4.0.0": {"releaseNotes": "dummy release notes", "displayName": "4.0.0- 123456", "released": "2021-01-27T23:01:58Z"},
    "4.1.0": {"releaseNotes": "dummy release notes", "displayName": "4.1.0 - 123456", "released": "2021-11-01T23:01:58Z"},
}
...
class TestMetadataParsing:
    ...
    def test_validate_all_fields_of_parsed_metadata(self, mocker, dummy_pack: Pack, dummy_pack_metadata):
...
class TestParsingInternalFunctions:
    ...
    @pytest.mark.parametrize(
        "pack_integration_images, display_dependencies_images, default_data_source, expected",
        [
            ([], [], {}, []),
            (
                [],
    ...
    def test_get_all_pack_images(
        self, mocker, pack_integration_images, display_dependencies_images, default_data_source, expected
    ):
        """
        ...
        all_pack_images = Pack._get_all_pack_images(
            "", pack_integration_images, display_dependencies_images, display_dependencies_images, default_data_source
        )
...
class TestHelperFunctions:
    ...
    @pytest.mark.parametrize(
        "modified_file_path_parts, expected_result",
        [
    ...
    @pytest.mark.parametrize(
        "input_data,capitalize_input,expected_result",
        [
    ...
    @pytest.mark.parametrize(
        "bool_input,expected",
        [(True, True), (False, False), ("True", True), ("False", False), ("Yes", True), ("No", False), (1, True), (0, False)],
    )
    ...
    @pytest.mark.parametrize("price_value_input,expected_price", [("", 0), ("0", 0), ("120", 120), ("not integer", 0)])
    ...
    @pytest.mark.parametrize(
        "current_string_version,compared_content_item,expected_result",
        [
    ...
    def test_get_updated_server_version(self, current_string_version, compared_content_item, expected_result):
        ...
        """
        result = get_updated_server_version(
            current_string_version=current_string_version, compared_content_item=compared_content_item, pack_name="dummy"
        )
    ...
    def tests_get_failed_packs_from_previous_upload(self, mocker):
        ...
        mock_blob.download_as_string.return_value = (
            b'{"failed_to_install": {"packs_to_upload": ["Pack1"], '
        ...
        assert failed_packs == {
            "failed_to_install": {"packs_to_upload": ["Pack1"], "packs_to_update_metadata": ["Pack2"]},
            "failed_to_upload": {"packs_to_upload": ["Pack1"], "packs_to_update_metadata": ["Pack2"]},
        }
...
class TestChangelogCreation:
    ...
    def test_prepare_release_notes_first_run(self, mocker, dummy_pack):
        ...
        task_status, not_updated_build, _ = Pack.prepare_release_notes(
            self=dummy_pack, index_folder_path=dummy_path, build_number=build_number
        )
    ...
    def test_get_modified_release_notes_lines(self, mocker, dummy_pack):
        ...
        mocker.patch(
            "Tests.Marketplace.marketplace_services.Pack.get_same_block_versions",
            return_value=(same_block_version_dict, higher_version),
        )
        mocker.patch(
            "Tests.Marketplace.marketplace_services.aggregate_release_notes_for_marketplace", return_value=modified_rn_lines
        )
    ...
    def test_assert_production_bucket_version_matches_release_notes_version_positive(self, dummy_pack):
        ...
        """
        changelog = {
            "1.0.0": {"releaseNotes": "First release notes", "displayName": "1.0.0", "released": "2020-05-05T13:39:33Z"},
            "2.0.0": {"releaseNotes": "Second release notes", "displayName": "2.0.0", "released": "2020-06-05T13:39:33Z"},
        }
        branch_latest_version = "2.0.1"
        Pack.assert_upload_bucket_version_matches_release_notes_version(dummy_pack, changelog, branch_latest_version)
...
"""
    ...
    def test_create_changelog_entry_new(self, dummy_pack):
        ...
        build_number = "5555"
        version_changelog, _ = dummy_pack._create_changelog_entry(
            release_notes=release_notes, version_display_name=version_display_name, build_number=build_number, new_version=True
        )
    ...
    def test_create_changelog_entry_existing(self, dummy_pack):
        ...
        dummy_pack._is_modified = True
        version_changelog, _ = dummy_pack._create_changelog_entry(
            release_notes=release_notes, version_display_name=version_display_name, build_number=build_number, new_version=False
        )
...
- Fixed dashboard"""
        ...
        build_number = "5555"
        id_set = {
            "integrations": [{"integration_id": {"file_path": "some/path", "display_name": "Integration Display Name"}}],
            "Dashboards": [],
        }
        dummy_pack._is_modified = True
        version_changelog, _ = dummy_pack._create_changelog_entry(
            release_notes=release_notes, version_display_name=version_display_name, build_number=build_number, id_set=id_set
        )
...
- Fixed another issue"""
        version_display_name = "1.2.3"
        build_number = "5555"
        id_set = {"integrations": [{"id": {"file_path": "some/path", "display_name": "Integration 2 Display Name"}}]}
        dummy_pack._is_modified = True
        version_changelog, _ = dummy_pack._create_changelog_entry(
            release_notes=release_notes, version_display_name=version_display_name, build_number=build_number, id_set=id_set
        )
...
- **Field Name 2**"""
        ...
        id_set = {
            "integrations": [
                {"id": {"file_path": "some/path", "display_name": "Other Integration Display Name", "marketplaces": []}}
            ],
            "IncidentFields": [],
        }
        dummy_pack._is_modified = True
    ...
    @pytest.mark.parametrize(
        "release_notes, upload_marketplace, expected_result",
        [
            (  # Case 1
                """
<~XSIAM>
...
- General pack change
    ...
    def test_create_filtered_changelog_entry_by_mp_tags(
        self, dummy_pack: Pack, release_notes, upload_marketplace, expected_result
    ):
        """
        Given:
        ...
        build_number = "5555"
        id_set = {
            "Packs": [{"id": {"name": "PackName", "display_name": "PackName", "marketplaces": []}}],
            "integrations": [{"id": {"file_path": "some/path", "display_name": "Integration Display Name", "marketplaces": []}}],
            "scripts": [{"id": {"file_path": "some/path", "display_name": "Script Name", "marketplaces": []}}],
            "IncidentFields": [{"id": {"display_name": "Field Name 1", "marketplaces": []}}],
        }
    ...
    @pytest.mark.parametrize(
        "is_metadata_exist, expected_date", [("metadata", "2020-04-14T00:00:00Z"), ("metadata_not_exist", "2020-11-04T13:34:14Z")]
    )
    ...
    @freeze_time("2020-11-04T13:34:14.75Z")
    @pytest.mark.parametrize("metadata_path, is_within_time_delta", [("metadata", False), ("metadata_not_exist", True)])
    ...
    @freeze_time("2020-11-04T13:34:14.75Z")
    @pytest.mark.parametrize(
        "is_changelog_exist, expected_date",
        [("changelog_new_exist", "2021-01-20T12:10:55Z"), ("changelog_not_exist", "2020-11-04T13:34:14Z")],
    )
...
class TestFilterChangelog:
    ...
    TAG_BY_MP = {"xsoar": "XSOAR", "marketplacev2": "XSIAM"}
...
- **Field name 2**
    ...
    @pytest.mark.parametrize(
        "marketplace, upload_marketplace, expected_result",
        [
            (
                "xsoar",
                "marketplacev2",
...
"""
    ...
    @pytest.mark.parametrize(
        ...
        [(XSOAR_MP, XSOAR_MP_RES), (XSOAR_SAAS_MP, XSOAR_SAAS_MP_RES), (XSIAM_MP, XSIAM_MP_RES)],
    )
...
- Updated the Docker image to: *demisto/ansible-runner:1.0.0.24037*."""
    ...
    res3 = {
        "Integrations": {
            "Ansible Cisco NXOS": "- Documentation and metadata improvements.\n- Fixed contextPath outputs for the ***nxos-facts*** command.\n- Updated the Docker image to: *demisto/ansible-runner:1.0.0.24037*.\n"  # noqa: E501
        }
    }
...
"""
    ...
    res4 = {
        "Integrations": {
            "Akamai WAF": "- Added 8 new commmands:\n  - ***akamai-get-production-deployment***\n  - ***akamai-get-change-history***\n  - ***akamai-modify-appsec-config-selected-hosts***\n  - ***akamai-patch-papi-property-rule-siteshield***\n  - ***akamai-update-appsec-config-version-notes***\n  - ***akamai-new-or-renew-match-target***\n  - ***akamai-patch-papi-property-rule-generic***\n  - ***akamai-get-papi-property-rule***\n\n- Added the following arguments to the ***akamai-create-enrollment*** command:\n   - *clone_dns_names*\n   - *exclude_sans*\n   - *change_management*\n   - *network_configuration_geography*\n   - *ra*\n   - *validation_type*\n   - *enable_multi_stacked_certificates*\n   - *network_configuration_quic_enabled*\n   - *network_configuration_secure_network*\n   - *network_configuration_sni_only*\n   - *indicator_type*\n   - *active_only*\n   - *confidence*\n   - *threat_assess_score*\n\n- Added the following arguments to the ***akamai-update-property*** command:\n   - *property_comments*\n   - *dc1_id*\n   - *dc2_id*\n\n- Added the following argument to the ***akamai-activate-papi-property*** command:\n   - *note*\n"  # noqa: E501
        }
    }
    ...
    def test_filter_by_display_name(self, dummy_pack: Pack, id_set, expected_result):
        ...
        Then:
            - Ensure the filtered entries resulte is as expected.
        """
        assert dummy_pack.filter_entries_by_display_name(self.RN_ENTRIES_DICTIONARY, id_set) == expected_result

    @pytest.mark.parametrize(
        "changelog_entry, marketplace, id_set, expected_rn",
        [
            (
                {Changelog.RELEASE_NOTES: "#### Integrations\n##### Display Name\n- Some entry 1.\n- Some entry 2."},
                "xsoar",
                {"integrations": [{"id": {"display_name": "Display Name"}}]},
                "#### Integrations\n##### Display Name\n- Some entry 1.\n- Some entry 2.",
            ),
            (
                {
...
- New: **HelloWorld SaaS**
    ...
    def test_changes_not_relevant_message_in_rn(self, dummy_pack: Pack, changelog_entry, marketplace, id_set, expected_rn):
        """
        Given:
        ...
        """
        assert (
            dummy_pack.filter_changelog_entries(changelog_entry, dummy_pack.current_version, marketplace, id_set)[0][
...
class TestImagesUpload:
    ...
    @pytest.mark.parametrize(
        "integration_name,expected_result",
        [
            (
    ...
    def test_upload_integration_images_with_special_character(self, mocker, dummy_pack, integration_name, expected_result):
        """
        Given:
    ...
    @pytest.mark.parametrize(
        "integration_name,expected_result",
        [
            ("Integration Name", [{"name": "Integration Name", "imagePath": "content/packs/TestPack/IntegrationName_image.png"}]),
            ("IntegrationName", [{"name": "IntegrationName", "imagePath": "content/packs/TestPack/IntegrationName_image.png"}]),
        ],
    )
    def test_upload_integration_images_without_special_character(self, mocker, dummy_pack, integration_name, expected_result):
        """
        Given:
    ...
    def test_copy_integration_images(self, mocker, dummy_pack):
        ...
        task_status = dummy_pack.copy_integration_images(
            dummy_prod_bucket, dummy_build_bucket, images_data, GCPConfig.CONTENT_PACKS_PATH, GCPConfig.BUILD_BASE_PATH
        )
        assert task_status
    ...
    def test_copy_preview_images(self, mocker, dummy_pack):
        ...
        task_status = dummy_pack.copy_preview_images(
            dummy_prod_bucket, dummy_build_bucket, images_data, GCPConfig.CONTENT_PACKS_PATH, GCPConfig.BUILD_BASE_PATH
        )
        assert task_status
    ...
    def test_upload_dynamic_dashboard_images(self, mocker, dummy_pack: Pack):
        ...
        mocker.patch.object(
            ...
            "glob",
            side_effect=[
                ["Packs/TestPack/Integrations/IntegrationId/IntegrationId_dark.svg"],
    ...
    def test_copy_dynamic_dashboard_images(self, mocker, dummy_pack: Pack):
        ...
        task_status = dummy_pack.copy_dynamic_dashboard_images(
            dummy_prod_bucket, dummy_build_bucket, images_data, GCPConfig.CONTENT_PACKS_PATH
        )
        assert task_status
    ...
    def test_copy_author_image(self, mocker, dummy_pack):
        ...
        task_status = dummy_pack.copy_author_image(
            dummy_prod_bucket, dummy_build_bucket, images_data, GCPConfig.CONTENT_PACKS_PATH, GCPConfig.BUILD_BASE_PATH
        )
        assert task_status
...
class TestCopyAndUploadToStorage:
    ...
    def test_copy_and_upload_to_storage_skip(self, mocker, dummy_pack):
        ...
        mocker.patch("Tests.Marketplace.marketplace_services.logging")
        task_status, skipped_pack = dummy_pack.copy_and_upload_to_storage(
            dummy_prod_bucket, dummy_build_bucket, {}, {}, GCPConfig.CONTENT_PACKS_PATH, GCPConfig.BUILD_BASE_PATH
        )
        assert task_status
        assert skipped_pack
...
- wow2
        ...
        mocker.patch("builtins.open", open_mocker)
        rn_lines, latest_rn, new_versions = dummy_pack.get_release_notes_lines("rn_dir_fake_path", Version("1.0.0"), "")
...
- wow1
        ...
        rn_lines, latest_rn, new_versions = dummy_pack.get_release_notes_lines("rn_dir_fake_path", Version("1.0.1"), rn)
...
- wow2
        ...
        mocker.patch("os.listdir", return_value=["1_0_0.md", "1_0_1.md"])
        rn_lines, latest_rn, new_versions = dummy_pack.get_release_notes_lines("wow", Version("1.0.1"), changelog_latest_rn)
        assert latest_rn == "1.0.1"
    ...
    CHANGELOG_ENTRY_CONTAINS_BC_VERSION_INPUTS = [
        ...
        (Version("0.0.0"), Version("1.0.0"), [Version("1.0.1")], {"1.0.1": "BC text"}, {}),
        (Version("0.0.0"), Version("1.0.0"), [Version("1.0.0")], {"1.0.0": None}, {"1.0.0": None}),
        (Version("2.3.1"), Version("2.4.0"), [Version("2.3.1")], {"2.3.1": "BC text"}, {}),
        (
            Version("2.3.1"),
            Version("2.4.0"),
            [Version("2.3.1"), Version("2.3.2")],
            {"2.3.1": None, "2.3.2": "BC Text 232"},
            {"2.3.2": "BC Text 232"},
        ),
    ]
    ...
    def test_changelog_entry_contains_bc_version(
        self, predecessor_version: Version, rn_version: Version, bc_versions_list: list[Version], bc_version_to_text, expected
    ):
        """
        Given:
        ...
        """
        assert (
            Pack._changelog_entry_bc_versions(predecessor_version, rn_version, bc_versions_list, bc_version_to_text) == expected
        )
    ...
    SPLIT_BC_VERSIONS_WITH_AND_WITHOUT_TEXT_INPUTS = [
        ...
        ({"1.0.2": None}, ([], ["1.0.2"])),
        ({"1.0.2": None, "1.0.4": None, "1.0.5": "txt1", "1.0.6": "txt2"}, (["txt1", "txt2"], ["1.0.2", "1.0.4"])),
    ]

    @pytest.mark.parametrize("bc_versions, expected", SPLIT_BC_VERSIONS_WITH_AND_WITHOUT_TEXT_INPUTS)
    def test_split_bc_versions_with_and_without_text(
        self, bc_versions: dict[str, str | None], expected: tuple[list[str], list[str]]
    ):
        """
        Given:
    ...
    def test_handle_many_bc_versions_some_with_text(self, dummy_pack, tmpdir):
        ...
        assert (
            dummy_pack._handle_many_bc_versions_some_with_text(rn_dir, text_of_bc_versions, bc_versions_without_text)
            == expected_concat_str
        )

    CALCULATE_BC_TEXT_NON_MIXED_CASES_INPUTS = [
        ({}, None),
        ({"1.0.2": None}, None),
        ({"1.0.2": "txt1"}, "txt1"),
    ...
    def test_calculate_bc_text_non_mixed_cases(self, dummy_pack, bc_version_to_text: dict[str, str | None], expected: str | None):
        """
        Given:
        - 'text_of_bc_versions': Text of BC versions containing specific BC text.
    ...
    def test_add_bc_entries_if_needed(self, dummy_pack, tmpdir):
        ...
        changelog: dict[str, Any] = {
            ...
            "1.12.16": {"releaseNotes": "RN of 1.12.16", "displayName": "1.12.16 - 391562", "released": "2021-06-30T23:32:59Z"},
            "1.12.23": {"releaseNotes": "RN of 1.12.23", "displayName": "1.12.23 - 393823", "released": "2021-07-06T23:27:59Z"},
            "1.12.24": {
        ...
        expected_changelog: dict[str, Any] = {
            ...
            "1.12.17": {"releaseNotes": "RN of 1.12.17", "displayName": "1.12.17 - 392184", "released": "2021-07-02T23:15:52Z"},
            "1.12.16": {"releaseNotes": "RN of 1.12.16", "displayName": "1.12.16 - 391562", "released": "2021-06-30T23:32:59Z"},
            "1.12.23": {
                "releaseNotes": "RN of 1.12.23",
                "displayName": "1.12.23 - 393823",
    ...
    FAILED_PACKS_DICT = {"TestPack": {"status": "wow1"}, "TestPack2": {"status": "wow2"}}

    @pytest.mark.parametrize(
        "failed_packs_dict, task_status, status",
        [
...
class TestStoreInCircleCIArtifacts:
    ...
    FAILED_PACK_DICT = {BucketUploadFlow.STATUS: PackStatus.FAILED_UPLOADING_PACK.name, BucketUploadFlow.AGGREGATED: "False"}
...
class TestGetSuccessfulAndFailedPacks:
    ...
    def test_get_successful_and_failed_packs(self, tmp_path):
                ...
                json.dumps(
                    {
                        f"{BucketUploadFlow.PREPARE_CONTENT_FOR_TESTING}": {
                            f"{BucketUploadFlow.FAILED_PACKS}": {
                                "TestPack2": {f"{BucketUploadFlow.STATUS}": "status2", f"{BucketUploadFlow.AGGREGATED}": False}
                            },
                            f"{BucketUploadFlow.SUCCESSFUL_PACKS}": {
                                "TestPack1": {f"{BucketUploadFlow.STATUS}": "status1", f"{BucketUploadFlow.AGGREGATED}": True}
                            },
        ...
        assert successful == {"TestPack1": {f"{BucketUploadFlow.STATUS}": "status1", f"{BucketUploadFlow.AGGREGATED}": True}}
        successful_list = [*successful]
        ans = "TestPack1" in successful_list
        assert ans

        assert failed == {"TestPack2": {f"{BucketUploadFlow.STATUS}": "status2", f"{BucketUploadFlow.AGGREGATED}": False}}
        failed_list = [*failed]
    ...
    class TestVersionsMetadataFile:
        ...
        def test_version_map(self):
            ...
            for version, core_packs_info in version_map_content.items():
                ...
                assert (
                    "core_packs_file" in core_packs_info
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (copy.deepcopy(CHANGELOG_MINOR_CHANGED_LAST_RELEASE_OLD_CHANGES), ["1.0.1", "1.0.2", "1.0.3", "1.0.4", "1.1.0"]),
        (
            copy.deepcopy(CHANGELOG_MINOR_CHANGED_LONG_TIME_AGO),
            ["1.1.0", "1.0.0", "1.1.1", "1.1.2", "1.1.3", "1.1.4", "1.1.5", "1.1.6", "1.1.7"],
        ),
...
def test_get_upload_data(mocker):
    ...
    load_json_data = {
        "prepare_content_for_testing": {
            "successful_packs": {
                "VirusTotal": {"status": "SUCCESS", "aggregated": "[2.6.6, 2.6.7, 2.6.8] => 2.6.8", "latest_version": "2.6.8"}
            },
            "images": {
                "readme_images": {
                    "LogRhythmRest": [],
...
def test_write_json(tmp_path):
    ...
    statistics_metadata = {Metadata.DOWNLOADS: 245, Metadata.SEARCH_RANK: 10}
    metadata_path = os.path.join(tmp_path, "metadata.json")
    shutil.copy(os.path.join(os.path.dirname(os.path.abspath(__file__)), "test_data", "metadata.json"), metadata_path)
