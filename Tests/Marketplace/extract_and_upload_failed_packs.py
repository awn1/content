...
def option_handler():
    ...
    parser.add_argument('-pu', '--packs_to_upload_file', required=True,
                        help="Path to the content_packs_to_upload.json file")
...
def main():
    ...
    failed_packs_upload = extract_failed_to_upload(load_json(option.packs_results_upload)) \
        if option.packs_results_upload else set()
