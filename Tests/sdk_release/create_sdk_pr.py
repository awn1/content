...
SLACK_PR_READY_MESSAGE = (
    "The demisto-sdk release PR is ready and waiting for review," " please approve it but don't merge it yet\n{sdk_pr}"
)
...
def main():
    ...
    data = {"ref": release_branch_name, "inputs": inputs}
