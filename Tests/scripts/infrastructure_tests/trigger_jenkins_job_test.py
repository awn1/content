...
@pytest.mark.parametrize(
    ...
    [
        (201, "Triggered Sync all buckets successfully"),
...
def test_main(mocker: MockerFixture, mock_status: int, expected_log: str):
    ...
    assert mock_logging.call_args_list[0][0][0] == expected_log
...
def test_main_with_some_error(mocker: MockerFixture):
    ...
    assert mock_logging.call_args_list[0][0][0] == "Triggered Sync all buckets failed, Error: test"
