...
@pytest.mark.parametrize(
    "mandatory_only, expected_summary",
    [
        pytest.param(
            False,
            (
        ...
        "3CXDesktopApp_Supply_Chain_Attack": {
            ...
            "removed": {
                "allLevelDependencies": {
                    "CommonTypes": {"display_name": "Common Types", "mandatory": True, "author": "Cortex XSOAR"},
                    "Cryptocurrency": {"display_name": "Cryptocurrency", "mandatory": True, "author": "Cortex XSOAR"},
                }
            },
        },
        "Campaign": {"added": {"dependencies": {"SplunkPy": {"display_name": "Splunk", "mandatory": True, "is_test": False}}}},
    }
...
@pytest.mark.parametrize(
    "summaries, mandatory_only, expected_str",
    [
        pytest.param(
            {
                mp: "data"
