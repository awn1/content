...
def get_all_pipelines_for_all_statuses(project: Project,
                                       branch_name: str,
                                       triggering_sources: list[str]) -> list[ProjectPipeline]:
...
def main():
    try:
        ...
        if not cancel_pipelines_for_branch_name(gitlab_client, project,
