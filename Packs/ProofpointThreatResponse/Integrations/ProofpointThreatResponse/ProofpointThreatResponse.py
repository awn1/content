...
def search_quarantine():
    ...
    request_params = {
        ...
        'fetch_delta': '168 hours',
        'fetch_limit': '50',
        'message_id': mid
    }
    demisto.debug(f"PTR {request_params=}")
    ...
    for alert in lstAlert:
        for quarantine in alert.get('quarantine_results'):
            demisto.debug(f"PTR {quarantine=}")
