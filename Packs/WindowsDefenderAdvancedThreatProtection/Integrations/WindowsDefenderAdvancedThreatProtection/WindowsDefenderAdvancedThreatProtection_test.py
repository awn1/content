...
def atp_mocker(mocker):
    ...
    with open('./test_data/alerts.json') as f:
...
def test_fetch(mocker):
    ...
    assert len(demisto.incidents.call_args[0][0]) == 3
    assert demisto.incidents.call_args[0][0][2].get('name') == \
           'Windows Defender ATP Alert da636983472338927033_-2077013687'
    ...
    atp.fetch_incidents()
    assert demisto.incidents.call_args[0][0][0].get('name') ==\
           'Windows Defender ATP Alert da637029414680409372_735564929'
