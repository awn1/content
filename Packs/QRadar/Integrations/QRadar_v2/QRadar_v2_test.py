...
class TestQRadarv2:
    ...
    def test_commands(self, command, command_func, args, mocker):
        """
    ...
    def test_try_create_search_with_retry__semi_happy(self, mocker):
        """
    ...
    def test_try_create_search_with_retry__sad(self, mocker):
        """
        Create an event search with a connection error first, and succesful try after
    ...
    def test_try_poll_offense_events_with_retry__semi_happy(self, mocker):
        """
    ...
    def test_get_assets_for_offense__empty(self):
