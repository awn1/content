...
github_comment_response_2 = [
    {"url": "https://api.github.com/repos/demisto/content/pulls/comments/477124056", "body": "Instance is ready. blablabla."},
    {
...
def test_get_pr_comments_url_existing(requests_mock):
    ...
    pr_number = "1"
    requests_mock.get(
        "https://api.github.com/repos/demisto/content/pulls/1",
...
def test_get_pr_comments_url_new(requests_mock):
    ...
    requests_mock.get(
        "https://api.github.com/repos/demisto/content/issues/1/comments",
        [{"json": github_comment_response_1, "status_code": 200}, {"json": github_comment_response_3, "status_code": 200}],
    )
