...
def options_handler():
    ...
    parser.add_argument(
        ...
        help=("Name of the bucket in Google Cloud Storage. " "Default value is marketplace-dist-dev."),
        required=False,
    )
    ...
    parser.add_argument(
        ...
        help=("Path to the Coverage report in json format. " "Default value is coverage.json."),
        required=False,
    )
    ...
    parser.add_argument(
        ...
        help=(
            "Filename of a minimal coverage report. "
    ...
    parser.add_argument(
        "-d",
        "--destination_blob_dir",
        default="code-coverage-reports",
        help=("Blob Name in Google Cloud Storage. " "Default value is code-coverage-reports."),
        required=False,
    )
