...
COLUMNS = [
    {'data': '', 'visible': True, 'filterable': False, 'className': 'dt-control',
     'orderable': 'false', 'key': '', 'defaultContent': ''},
    {'data': 'Host', 'visible': True, 'filterable': False, 'key': 'host'},
    {'data': 'Machine Mame', 'visible': True, 'filterable': False, 'key': 'machine_name'},
    {'data': 'Enabled', 'visible': True, 'filterable': True, 'key': 'enabled'},
    {'data': 'Flow Type', 'visible': True, 'filterable': True, 'key': 'flow_type'},
    {'data': 'Platform Type', 'visible': True, 'filterable': True, 'key': 'platform_type'},
    {'data': 'Server Version', 'visible': True, 'filterable': True, 'key': 'version'},
    {'data': 'LCAAS ID', 'visible': True, 'filterable': False, 'key': 'lcaas_id'},
]
...
def create_report(current_date: str, records: list[dict], columns, columns_filterable) -> str:
...
def main():
    ...
    report = create_report(current_date, records, COLUMNS, columns_filterable)
